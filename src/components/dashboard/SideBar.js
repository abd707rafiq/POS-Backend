  ...
  return (
    ...
    <div className={`whitespace-nowrap min-h-[558px] py-[20px] w-full ${clicked ? "flex" : "hidden"}   md:flex bg-gray-100  flex-col`}>
      ...
      {li1 && <div className='flex flex-col mx-4'>
        <NavLink to={"/home/contacts/supplier"} className='flex hover:text-black aria-[current=page]:font-bold aria-[current=page]:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Suppliers</h1>
        </NavLink>
        <NavLink to={"/home/contacts/customer"} className='flex hover:text-black aria-[current=page]:font-bold aria-[current=page]:text-black py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
      ...
      {li5 && <div className='flex flex-col mx-4'>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>List Stock Transfer</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Add Stock Transfer</h1>
        </Link>
      ...
      {li6 && <div className='flex flex-col mx-4'>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>List Stock Adjustment</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Add Stock Adjustment</h1>
        </Link>
      ...
      {li7 && <div className='flex flex-col mx-4'>
        ...
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Expense Categories</h1>
        </Link>
      </div>
      }
      {/* Payment Accounts */}
      ...
      {li8 && <div className='flex flex-col mx-4'>
        ...
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Payment Account Report</h1>
        </Link>
      </div>
      }
      {/* Reports */}
      ...
      {li9 && <div className='flex flex-col mx-4'>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Profit/Loss Report</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Purchase & Sale</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
        ...
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Customer Groups Report</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
        ...
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Stock Adjustment Report</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Trending Products</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
        ...
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Product Purchase Report</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Product Sell Report</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Purchase Payment Report</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Sell Payment Report</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Expense Report</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Register Report</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
        ...
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Service Staff Report</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
      ...
      {li10 && <div className='flex flex-col mx-4'>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Business Settings</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Business Locations</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Invoice Settings</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Barcode Settings</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Receipt Printers</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
        ...
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Type of Services</h1>
        </Link>
        <Link to={"/"} className='flex hover:text-black  py-1 items-center   justify-start'>
          <BsArrowRight size={15} />
          <h1 className=' mt-1 ml-5 text-gray-500 text-sm '>Package Subscriptions</h1>
        </Link>
